...
1. **rag_tool**: per cercare informazioni rilevanti all'interno del database di documenti ufficiali e fidati. Deve essere la tua prima scelta per argomenti tecnici.
2. **web_search_tool**: per effettuare ricerche sul web e raccogliere informazioni esterne.
</Available Tools>
